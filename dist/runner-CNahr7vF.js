...
import { A as kindFromMime, E as getFileExtension, O as isAudioFileName, Y as normalizeChatType, w as detectMime } from "./image-ops-CEhvmfZb.js";
import { A as normalizeGoogleModelId, _ as resolveOpenClawAgentDir, i as resolveApiKeyForProvider, r as requireApiKey, w as normalizeProviderId } from "./model-auth-BWNeE8AB.js";
import { n as loadConfig } from "./config-CVffLdk5.js";
import { b as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-BNHc4FrW.js";
import { a as fetchWithTimeout, n as fetchRemoteMedia, r as fetchWithSsrFGuard, t as MediaFetchError } from "./fetch-m-t-1bsN.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-BfMWHX-f.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
