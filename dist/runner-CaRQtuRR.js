...
import { H as resolveOpenClawAgentDir, S as resolveApiKeyForProvider, f as normalizeGoogleModelId, o as normalizeProviderId, x as requireApiKey } from "./model-selection-CKlXm6pe.js";
import { C as detectMime, D as isAudioFileName, J as normalizeChatType, T as getFileExtension, k as kindFromMime } from "./image-ops-3k3jUTui.js";
import { n as loadConfig } from "./config-CpsUWe0r.js";
import { b as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-CggVQcHG.js";
import { a as fetchWithTimeout, n as fetchRemoteMedia, r as fetchWithSsrFGuard, t as MediaFetchError } from "./fetch-D1NTcRuw.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-tAHdMZoM.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
