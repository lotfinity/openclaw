...
import { H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, W as normalizeVerboseLevel } from "./pi-embedded-helpers-BF3lzKDp.js";
import { At as getRemoteSkillEligibility, Cn as AGENT_LANE_NESTED, I as resolveOutboundTarget, L as resolveSessionDeliveryTarget, On as registerAgentRunContext, Sr as applyVerboseOverride, Tn as emitAgentEvent, Ut as getSkillsSnapshotVersion, V as runWithModelFallback, Vr as resolveAgentTimeoutMs, br as clearSessionAuthProfileOverride, i as runCliAgent, l as runEmbeddedPiAgent, n as getCliSessionId, r as setCliSessionId, s as resolveSendPolicy, wn as clearAgentRunContext, xr as applyModelOverrideToSessionEntry, yr as lookupContextTokens } from "./reply-DLSmOGEW.js";
...
import { Ct as ensureAuthProfileStore, Ft as DEFAULT_CONTEXT_TOKENS, It as DEFAULT_MODEL, Lt as DEFAULT_PROVIDER, a as isCliProvider, d as resolveConfiguredModelRef, h as resolveThinkingDefault, o as modelKey, t as buildAllowedModelSet } from "./model-selection-BS39NEIx.js";
...
import { C as resolveChannelResetConfig, S as evaluateSessionFreshness, T as resolveSessionResetType, i as loadSessionStore, j as resolveExplicitAgentSessionKey, l as updateSessionStore, v as normalizeAccountId, w as resolveSessionResetPolicy, x as resolveSessionKey } from "./sessions-Bp-SHSt0.js";
...
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-BKbF8JWV.js";
...
function createDefaultDeps() {
	return {
		sendMessageWhatsApp: async (...args) => {
			const { sendMessageWhatsApp } = await import("./web-DCQFC2Z_.js");
			return await sendMessageWhatsApp(...args);
		},
		sendMessageTelegram: async (...args) => {
			const { sendMessageTelegram } = await import("./send-BxEZRY3i.js").then((n) => n.s);
			return await sendMessageTelegram(...args);
		},
		sendMessageDiscord: async (...args) => {
			const { sendMessageDiscord } = await import("./send-Hn0zhgzD.js").then((n) => n.t);
			return await sendMessageDiscord(...args);
		},
		sendMessageSlack: async (...args) => {
			const { sendMessageSlack } = await import("./send-Cf6gPnum.js").then((n) => n.n);
			return await sendMessageSlack(...args);
		},
		sendMessageSignal: async (...args) => {
			const { sendMessageSignal } = await import("./send-CuL6Zoti.js").then((n) => n.i);
			return await sendMessageSignal(...args);
		},
		sendMessageIMessage: async (...args) => {
			const { sendMessageIMessage } = await import("./send-VWhZP-zV.js").then((n) => n.n);
