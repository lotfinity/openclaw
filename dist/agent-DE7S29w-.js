...
import { A as modelKey, F as resolveConfiguredModelRef, Mt as DEFAULT_CONTEXT_TOKENS, Nt as DEFAULT_MODEL, Pt as DEFAULT_PROVIDER, T as buildAllowedModelSet, k as isCliProvider, v as ensureAuthProfileStore, z as resolveThinkingDefault } from "./auth-profiles-CrPm8QA6.js";
...
import { At as getRemoteSkillEligibility, Cn as clearAgentRunContext, Dn as registerAgentRunContext, I as resolveOutboundTarget, L as resolveSessionDeliveryTarget, Sn as AGENT_LANE_NESTED, Ut as getSkillsSnapshotVersion, V as runWithModelFallback, cr as clearSessionAuthProfileOverride, i as runCliAgent, kr as resolveAgentTimeoutMs, l as runEmbeddedPiAgent, lr as applyModelOverrideToSessionEntry, n as getCliSessionId, r as setCliSessionId, s as resolveSendPolicy, ur as applyVerboseOverride, wn as emitAgentEvent } from "./reply-BQBuMSTO.js";
...
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-Dv9lu3B7.js";
import { H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, W as normalizeVerboseLevel } from "./pi-embedded-helpers-B1pSLPE2.js";
import { A as resolveExplicitAgentSessionKey, C as resolveSessionResetPolicy, S as resolveChannelResetConfig, b as resolveSessionKey, i as loadSessionStore, l as updateSessionStore, v as normalizeAccountId, w as resolveSessionResetType, x as evaluateSessionFreshness } from "./sessions-D5mfxA3z.js";
...
function createDefaultDeps() {
	return {
		sendMessageWhatsApp: async (...args) => {
			const { sendMessageWhatsApp } = await import("./web-BVAV1u6p.js");
			return await sendMessageWhatsApp(...args);
		},
		sendMessageTelegram: async (...args) => {
			const { sendMessageTelegram } = await import("./send-D6tLyP6u.js").then((n) => n.s);
			return await sendMessageTelegram(...args);
		},
		sendMessageDiscord: async (...args) => {
			const { sendMessageDiscord } = await import("./send-CPqQktXh.js").then((n) => n.t);
			return await sendMessageDiscord(...args);
		},
		sendMessageSlack: async (...args) => {
			const { sendMessageSlack } = await import("./send-BgSx_-TW.js").then((n) => n.n);
			return await sendMessageSlack(...args);
		},
		sendMessageSignal: async (...args) => {
			const { sendMessageSignal } = await import("./send-B4QakEzb.js").then((n) => n.i);
			return await sendMessageSignal(...args);
		},
		sendMessageIMessage: async (...args) => {
			const { sendMessageIMessage } = await import("./send-zAV7bMzL.js").then((n) => n.n);
