...
import { H as resolveApiKeyForProvider, Ot as resolveOpenClawAgentDir, V as requireApiKey, s as normalizeProviderId, x as normalizeGoogleModelId } from "./model-selection-BS39NEIx.js";
import { i as loadConfig } from "./config-Ck3rODdu.js";
import { b as normalizeChatType } from "./plugins-DsO8Iwb1.js";
import { t as describeImageWithModel, v as ensureOpenClawModelsJson } from "./image-B0wemo9Q.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-C4BhAVZq.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
