...
import { G as shouldDeferShellEnvFallback, K as shouldEnableShellEnvFallback, L as DEFAULT_CONTEXT_TOKENS, T as parseModelRef, U as loadShellEnvFallback, W as resolveShellEnvFallbackTimeoutMs } from "./model-auth-BWNeE8AB.js";
...
const WhatsAppWahaSchema = z.object({
	baseUrl: z.string().optional(),
...
//#endregion
export { resolveWhatsAppAccount as A, resolveWebCredsBackupPath as B, getConfigValueAtPath as C, isSafeExecutableValue as D, unsetConfigValueAtPath as E, logoutWeb as F, webAuthExists as H, maybeRestoreCredsFromBackup as I, pickWebChannel as L, WA_WEB_AUTH_DIR as M, getWebAuthAgeMs as N, resolveAgentMaxConcurrent as O, logWebSelfId as P, readWebSelfId as R, unsetConfigOverride as S, setConfigValueAtPath as T, resolveWebCredsPath as V, resolveEnableState as _, writeConfigFile as a, resetConfigOverrides as b, TELEGRAM_COMMAND_NAME_PATTERN as c, parseDurationMs as d, validateJsonSchemaValue as f, normalizePluginsConfig as g, applyTestPluginDefaults as h, resolveConfigSnapshotHash as i, resolveWhatsAppTransportId as j, VERSION as k, normalizeTelegramCommandName as l, discoverOpenClawPlugins as m, loadConfig as n, validateConfigObjectWithPlugins as o, loadPluginManifestRegistry as p, readConfigFileSnapshot as r, parseByteSize as s, createConfigIO as t, resolveTelegramCustomCommands as u, resolveMemorySlotDecision as v, parseConfigPath as w, setConfigOverride as x, getConfigOverrides as y, resolveDefaultWebAuthDir as z };