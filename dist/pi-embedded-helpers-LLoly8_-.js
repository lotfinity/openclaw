...
import { t as sanitizeContentBlocksImages } from "./tool-images-9mo8c514.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-D4Kl_Rpb.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-D4Kl_Rpb.js")).closePlaywrightBrowserConnection();
		} catch {}
