...
import { B as CHANNEL_MESSAGE_ACTION_NAMES, R as formatTargetDisplay, ft as CHANNEL_TARGETS_DESCRIPTION, j as runMessageAction, pt as CHANNEL_TARGET_DESCRIPTION, rn as registerMemoryCli, t as getReplyFromConfig, wt as resolveCommitHash, yr as lookupContextTokens } from "./reply-DLSmOGEW.js";
...
import { F as VERSION, I as loadDotEnv, _ as parseDurationMs, i as loadConfig, l as writeConfigFile, o as readConfigFileSnapshot, r as createConfigIO } from "./config-Ck3rODdu.js";
...
import { O as resolveFreshSessionTotalTokens, b as deriveSessionKey, i as loadSessionStore, s as saveSessionStore, x as resolveSessionKey } from "./sessions-Bp-SHSt0.js";
import { d as installUnhandledRejectionHandler, v as applyTemplate } from "./runner-rq38bqqY.js";
...
import { i as randomIdempotencyKey, n as callGateway } from "./call-xPOYP6Je.js";
...
import { a as ensureWorkspaceAndSessions, c as handleReset, d as openUrl, h as resolveControlUiLinks, i as detectBrowserOpenSupport, l as moveToTrash, m as randomToken, n as applyWizardMetadata, o as formatControlUiSshHint, t as DEFAULT_WORKSPACE, y as waitForGatewayReachable } from "./onboard-helpers-3NUo1HP2.js";
...
import { r as waitForever, t as monitorWebChannel } from "./channel-web-FkcqKrpZ.js";
import "./outbound-CpbJD0W_.js";
import "./login-qr-CAjzk8_e.js";
import "./login-BvkYttFP.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, o as createDefaultDeps, t as agentCommand } from "./agent-DjB4Xxga.js";
import { t as isMainModule } from "./is-main-r2s2HUP-.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Ca-F9ZPm.js";
import { a as gatewayInstallErrorHint, g as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-xwOchr7S.js";
import { a as buildAgentSummaries, c as loadAgentIdentity, f as parseIdentityMarkdown, i as applyAgentConfig, l as pruneAgentConfig, o as findAgentEntryIndex, r as runOnboardingWizard, s as listAgentEntries, t as statusCommand, u as identityHasValues } from "./status-BYnd_TZc.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-b1mCfFO1.js";
import { t as formatHelpExamples } from "./help-format-DK-uCZ3Y.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-huabwyFu.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-BVYMnEEG.js";
import "./note-bW_-5NR4.js";
import { t as WizardCancelledError } from "./prompts-DuxSVtOf.js";
import { t as createClackPrompter } from "./clack-prompter-CahGOejt.js";
import { C as formatAuthChoiceChoicesForCli, S as promptAuthChoiceGrouped, T as normalizeLegacyOnboardAuthChoice, _ as applyAuthChoice, a as CustomApiError, b as detectZaiEndpoint, g as warnIfModelConfigLooksOff, l as resolveCustomProviderId, o as applyCustomApiConfig, s as parseNonInteractiveCustomApiFlags, v as applyOpenAIConfig, w as isDeprecatedAuthChoice, x as applyGoogleGeminiModelDefault, y as upsertSharedEnvVar } from "./onboard-skills-uAbb47JO.js";
import { B as applyVeniceConfig, C as applyAuthProfileConfig, Ct as setXiaomiApiKey, E as applyKimiCodeConfig, Ft as validateAnthropicSetupToken, H as applyXaiConfig, I as applySyntheticConfig, J as applyLitellmConfig, K as applyZaiConfig, M as applyOpenrouterConfig, O as applyMoonshotConfig, P as applyQianfanConfig, Pt as buildTokenProfileId, Q as applyVercelAiGatewayConfig, R as applyTogetherConfig, St as setXaiApiKey, W as applyXiaomiConfig, X as applyCloudflareAiGatewayConfig, _ as applyOpencodeZenConfig, _t as setQianfanApiKey, bt as setVeniceApiKey, ct as setCloudflareAiGatewayConfig, dt as setKimiCodingApiKey, ft as setLitellmApiKey, gt as setOpenrouterApiKey, ht as setOpencodeZenApiKey, k as applyMoonshotConfigCn, lt as setGeminiApiKey, mt as setMoonshotApiKey, pt as setMinimaxApiKey, st as setAnthropicApiKey, ut as setHuggingfaceApiKey, vt as setSyntheticApiKey, w as applyHuggingfaceConfig, wt as setZaiApiKey, x as applyMinimaxConfig, xt as setVercelAiGatewayApiKey, y as applyMinimaxApiConfig, yt as setTogetherApiKey } from "./github-copilot-auth-BomQaW-Z.js";
import { n as setupChannels } from "./onboard-channels-CYxsnyrp.js";
import "./plugin-auto-enable-DU4XuNha.js";
import "./archive-CWp1KXBs.js";
import "./skill-scanner-D2jY3Gqv.js";
import "./installs-D-aXs9aF.js";
import { i as hasExplicitOptions, n as resolveCliChannelOptions, r as ensurePluginRegistryLoaded } from "./channel-options-CUds71P7.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-C5vNh-_6.js";
import { r as healthCommand } from "./health-BxPsKDl7.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-BGapBsRB.js";
import { t as resolveGatewayService } from "./service-BcUVkSMt.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-n1QOl9M_.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-B7J3j-jO.js";
import "./widearea-dns-l6yDhjgA.js";
import "./skills-status-C5Ij14Ux.js";
import "./auth-health-rM_JvgrK.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-DDVELxdi.js";
import { c as registerSubCliCommands, d as hasHelpOrVersion, f as shouldMigrateStateFromPath, l as getCommandPath, u as getVerboseFlag } from "./completion-cli-DDkRRad-.js";
import "./status.update-B4ALuj44.js";
import "./service-audit-XWattxYX.js";
import "./channels-status-issues-CnZQ8Zfj.js";
import { t as renderTable } from "./table-C5x4TdBn.js";
import "./hooks-status-DAxlyMz8.js";
import "./tui-Bz3mRUsB.js";
import "./audit-DgTyTfRQ.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-BGapBsRB.js").then((n) => n.t);
